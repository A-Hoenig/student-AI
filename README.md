...
For the purpose of this project, I will use the second set to demonstrate some data cleaning that might be required before the exploratory data ananlysis and model training.
